...
function ageInDays() {
    ...
    document.getElementById('flex-box-result').appendChild(X);
...
//Chellenge 3: Rock Paper Scissors
function rpsGame(yourChoice){
    ...
    message = finalMessage(results); //you won or you lose
    console.log(message);
...
{
    return Math.floor(Math.random() *3); //to pick any random number among 0 and 2.
...
function blackjackDeal(){
    if (blackjackGame['turnsOver'] === true){
        ...
        //showResult(computeWinner()); // if you want to play two players then add this function here.
